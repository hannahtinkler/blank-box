...
<h1><?php echo env('APP_NAME', 'Black Box'); ?> Contributors</h1>

<hr>

<p>This is a community project, contributed to by many hands from the Mayden developer family. If you'd like to be one (or two) such hands, you could:</p>
...
<ul>
    ...
    <li class="m-t-md">Fork <a target="_blank" href="https://github.com/hannahtinkler/black-box">the Black Box repositiory</a> and submit all kinds of information-centric paraphernalia and code-iness via pull request. If you'd like to be able to refer to <?php echo env('APP_NAME', 'Black Box'); ?> for something it does not yet offer, you could build it.</li>
</ul>
