...
<ul>
    ...
    <li class="m-t-md">Fork the Black Box repositiory and submit all kinds of information-centric paraphernalia and code-iness via pull request. If you'd like to be able to refer to <?php echo env('APP_NAME', 'Black Box'); ?> for something it does not yet offer, you could build it.</li>
</ul>
