...
<ul>
    <li class="m-t-md">Add new articles whenever you find yourself making notes that might help someone else, think of something important that isn't already covered here, or just whenever you have a spare 10 minutes. (Okay, maybe that last one is unlikely. But you could make time maybe?)</li>
    <li class="m-t-md">Volunteer as a curator, meaning you'd help maintain the quality and readability of the articles and suggested edits that are submitted to the knowledge base.</li>
