...
<h1><?php echo config('global.site-name'); ?> Contributors</h1>
...
<ul>
    ...
    <li class="m-t-md">Fork the Black Box repositiory and submit all kinds of information-centric paraphernalia and code-iness via pull request. If you'd like to be able to refer to <?php echo config('global.site-name'); ?> for something it does not yet offer, you could build it.</li>
</ul>
